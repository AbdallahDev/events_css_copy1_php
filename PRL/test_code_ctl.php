...
$event->update_event($event_entity, $event_entity_name, $_POST['time'], $hall_id, $event_place, nl2br($_POST['subject']), $_POST['event_date'], $event_status, date("Y-m-d H:i:s"), $_SESSION['directorate'], $_SESSION['user_id'], $_POST['id']);
